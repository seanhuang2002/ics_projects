...
public class DbUtilitaires {
		...
		private static final String connStr="jdbc:mysql://lessonplus.com:3306/lessonpl_nathalie?zeroDateTimeBehavior=CONVERT_TO_NULL&serverTimezone=UTC";
		/*===================================================================
		...
		public static void dbConnect() throws SQLException,ClassNotFoundException
		{
			...
			try {
				connection=DriverManager.getConnection(connStr, "lessonpl_nathalie", "nathalieTFS123!");
			}
